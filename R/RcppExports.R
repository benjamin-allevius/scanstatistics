...
#'    }
#' @keywords internal
scan_eb_poisson_cpp <- function(counts, agg_baselines, zones, zone_lengths) {
...
#' @keywords internal
est_eb_zip_zeroindic <- function(mu, p, q) {
    .Call('scanstatistics_est_eb_zip_zeroindic', PACKAGE = 'scanstatistics', mu, p, q)
}
...
#'    } 
#' @keywords internal
scan_eb_zip_cpp <- function(counts, baselines, probs, zones, zone_lengths, rel_tol = 1e-3) {
...
#'    } 
#' @keywords internal
scan_eb_zip_cpp_max <- function(counts, baselines, probs, zones, zone_lengths, rel_tol = 1e-3) {
    .Call('scanstatistics_scan_eb_zip_cpp_max', PACKAGE = 'scanstatistics', counts, baselines, probs, zones, zone_lengths, rel_tol)
}
...
#'    }
#' @keywords internal
scan_pb_poisson_cpp <- function(counts, agg_baselines, zones, zone_lengths, N) {
